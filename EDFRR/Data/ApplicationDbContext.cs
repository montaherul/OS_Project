...
public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
{
    ...
    private static void SeedData(ModelBuilder builder)
    {
        ...
        builder.Entity<ApplicationUser>().HasData(
            ...
            {
                Id = adminId,
                UserName = "admin@edfrr.com",
                NormalizedUserName = "ADMIN@EDFRR.COM",
                Email = "admin@edfrr.com",
                NormalizedEmail = "ADMIN@EDFRR.COM",
                EmailConfirmed = true,
            ...
            {
                Id = userId,
                UserName = "user@edfrr.com",
                NormalizedUserName = "USER@EDFRR.COM",
                Email = "user@edfrr.com",
                NormalizedEmail = "USER@EDFRR.COM",
                EmailConfirmed = true,
