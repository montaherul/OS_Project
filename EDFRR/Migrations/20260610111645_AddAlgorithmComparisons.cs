    ...
    public partial class AddAlgorithmComparisons : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { new DateTime(2026, 6, 10, 11, 16, 44, 436, DateTimeKind.Utc).AddTicks(92), "admin@edfrr.com", "admin@edfrr.com" });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "CreatedAt", "Email", "UserName" },
                values: new object[] { new DateTime(2026, 6, 10, 11, 16, 44, 436, DateTimeKind.Utc).AddTicks(99), "user@edfrr.com", "user@edfrr.com" });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: "8e445865-e2ff-4350-84d0-4c83e07bf1f3",
                columns: new[] { "CreatedAt", "Email", "UserName" },
                values: new object[] { new DateTime(2026, 6, 10, 8, 31, 39, 262, DateTimeKind.Utc).AddTicks(1428), "admin@edfrr.com", "admin@edfrr.com" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
                columns: new[] { "CreatedAt", "Email", "UserName" },
                values: new object[] { new DateTime(2026, 6, 10, 8, 31, 39, 262, DateTimeKind.Utc).AddTicks(1435), "user@edfrr.com", "user@edfrr.com" });
        }
    }
}
