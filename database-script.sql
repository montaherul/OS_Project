...
BEGIN
    ...
    VALUES (N''8e445865-e2ff-4350-84d0-4c83e07bf1f3'', 0, N''admin-concurrency-stamp'', ''2026-06-10T08:25:44.9993676Z'', N''admin@erdr.com'', CAST(1 AS bit), N''Admin'', CAST(1 AS bit), NULL, N''User'', CAST(0 AS bit), NULL, N''ADMIN@ERDRR.COM'', N''ADMIN@ERDRR.COM'', N''AQAAAAIAAYagAAAAELtGVmMnKfBqKz0Vr3nL9qI1sH5Gx2y4a7b8c0d2e4f6g8h0i2j4k6l8m0n2o=='', NULL, CAST(0 AS bit), NULL, N''ADMIN_SECURITY_STAMP_001'', CAST(0 AS bit), N''admin@erdr.com''),
    (N''a1b2c3d4-e5f6-7890-abcd-ef1234567890'', 0, N''user-concurrency-stamp'', ''2026-06-10T08:25:44.9993698Z'', N''user@erdr.com'', CAST(1 AS bit), N''Test'', CAST(1 AS bit), NULL, N''User'', CAST(0 AS bit), NULL, N''USER@ERDRR.COM'', N''USER@ERDRR.COM'', N''AQAAAAIAAYagAAAAELtGVmMnKfBqKz0Vr3nL9qI1sH5Gx2y4a7b8c0d2e4f6g8h0i2j4k6l8m0n2o=='', NULL, CAST(0 AS bit), NULL, N''USER_SECURITY_STAMP_001'', CAST(0 AS bit), N''user@erdr.com'')');
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'AccessFailedCount', N'ConcurrencyStamp', N'CreatedAt', N'Email', N'EmailConfirmed', N'FirstName', N'IsActive', N'LastLoginAt', N'LastName', N'LockoutEnabled', N'LockoutEnd', N'NormalizedEmail', N'NormalizedUserName', N'PasswordHash', N'PhoneNumber', N'PhoneNumberConfirmed', N'ProfilePictureUrl', N'SecurityStamp', N'TwoFactorEnabled', N'UserName') AND [object_id] = OBJECT_ID(N'[Users]'))
